        ...
        <div class="row mrgn30">
          <form method="post" action="realizar_registro.php" id="contactfrm" role="form">
            <div class="col-sm-12">
              ...
              <h2>El correo ya está registrado, utilice uno diferente</h2>
  	    ...
  	    <div class="form-group">
                ...
                <input type="text" class="form-control" name="direccion" placeholder="Domicilio" maxlength="100" title="Ingrese su dirección" required>
              </div>
  	    <div class="form-group">
